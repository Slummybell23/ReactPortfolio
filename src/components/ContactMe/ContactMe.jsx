...
function ContactMe() {
    ...
    return (
        <section className="contact-me relative">
            <div className="contact-me-title font-bold mb-12">
                Contact Me!
            </div>

            <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12 px-4 text-base text-left md:divide-x divide-slate-700/50">

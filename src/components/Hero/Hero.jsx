        ...
        <section id="home" className="scroll-mt-20">
            <div className="mx-auto max-w-5xl px-6 py-20 md:py-36">
                ...
                <p className="mt-6 max-w-2xl text-lg leading-relaxed text-neutral-600 md:text-xl">
                    I build things for the love of it — from iOS apps on the App Store to
                    self-hosted home-server tooling. Currently studying Computer Science and
                    writing software professionally.
                </p>
                ...
                <div className="mt-10 flex flex-wrap items-center gap-4">
                    ...
                    <div className="ml-1 flex items-center gap-1">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="Forgejo (self-hosted Git)"
                            className="flex h-10 w-10 items-center justify-center rounded-full text-neutral-500 transition-colors hover:bg-neutral-100 hover:text-neutral-900"
                        >
